...
const SCENARIO_ROLES: Record<Scenario, string> = {
  ...
  physician:     "You are a patient visiting a medical clinic for a general check-up or because you feel unwell. The learner is playing the role of the physician. Present realistic symptoms — vary the complaint each time (e.g. headache, sore throat, stomach pain, fatigue, cough). Answer the doctor's questions naturally and honestly. Your symptoms and situation should adapt in complexity to the learner's CEFR level.",
  soldier:       "You are a fellow soldier deployed in the field alongside the learner. The mission and terrain vary — describe what you observe around you (hills, roads, buildings, open ground). Make callouts, ask for information, and respond to the learner's reports. Use military vocabulary appropriate to the learner's level. Stay calm but urgent when the situation calls for it.",
  emergency_help:"You are a person in need of help. The situation changes slightly each time — you might be injured, lost, or asking on behalf of someone else nearby. You are distressed but cooperative. Respond genuinely to the learner's attempts to help. As the scenario progresses, provide more detail about what happened.",
...
const SCENARIO_COMPLETION_GOALS: Record<Scenario, string> = {
  ...
  physician:     "The lesson is complete when the learner (as physician) has greeted you, asked about your symptoms, you have described your complaint, they have asked at least one follow-up question, and they have given you a diagnosis, advice, or a prescription to end the consultation.",
  soldier:       "The lesson is complete when the learner has made at least two callouts or terrain descriptions, you have responded and added information, and you have both coordinated on a course of action to wrap up the field exercise.",
  emergency_help:"The lesson is complete when the learner has assessed your situation by asking what happened, taken at least one concrete action to help (calling for help, giving instructions, providing reassurance), and the situation has been stabilized or you have been handed off to emergency services.",
